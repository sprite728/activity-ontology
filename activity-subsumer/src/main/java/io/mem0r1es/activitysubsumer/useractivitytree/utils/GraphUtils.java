...
public final class GraphUtils {
     ...
     *
     * @param filename  file name (or path) from which to read
     * @param edgeClazz class of the edges to use (JGraphT needs this)
     */
     ...
     * Reads a directed acyclic graph (DAG) from a file
     *
     * @param file      {@link java.io.File} object from which to read
     * @param edgeClazz class of the edges to use (JGraphT needs this)
     */
    public static <E> DirectedAcyclicGraph<String, E> buildDAG(File file,
            Class<? extends E> edgeClazz) throws
            IOException {
     ...
     *
     * @param is        {@link java.io.InputStream} object from which to read
     * @param edgeClazz class of the edges to use (JGraphT needs this)
     */
    ...
    /**
     * @return a {@link java.util.Set} of descendants of a node in a {@link org.jgrapht.DirectedGraph}
     */
    ...
    /**
     * <p>Find the deepest node in a directed acyclic graph from a set of nodes.</p><p>The depth of a node is the maximum depth through
     * any path that reaches that node.</p>
     *
    ...
    /**
     * <p>Return the maximum depth of <i>node</i> in <i>graph</i></p>
     *
    ...
    /**
     * <p>Explore a directed acyclic graph using a breadth first search approach and create a depth map for the nodes.</p><p>The depth of
     * a node is the maximum depth through any path that reaches that node.</p>
     *
        ...
        while (!queue.isEmpty()) {
            ...
            for (E edge : graph.outgoingEdgesOf(vertex)) {
                ...
                if (!visited.contains(next) ||
                        (depthMap.containsKey(next) && (dist + 1) > depthMap.get(next))) {
