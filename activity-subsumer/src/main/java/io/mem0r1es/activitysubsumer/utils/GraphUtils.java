...
public final class GraphUtils {
     ...
     */
    public static <E> DirectedAcyclicGraph<String, E> buildDAG(String filename,
                                                               Class<? extends E> edgeClazz) throws IOException {
     ...
     *            class of the edges to use (JGraphT needs this)
     */
    public static <E> DirectedAcyclicGraph<String, E> buildDAG(InputStream is,
                                                               Class<? extends E> edgeClazz) throws IOException {
        ...
        for (String vertex : dag.vertexSet()) {
            if (dag.inDegreeOf(vertex) == 0 && !vertex.equals(DEFAULT_ROOT)) {
    ...
    public static <V, E> Set<V> ancestors(DirectedGraph<V, E> graph, V node) {
        ...
        BreadthFirstIterator<V, E> iterator = new BreadthFirstIterator<V, E>(reversedGraph, node);
    ...
    public static <V, E> Set<V> descendants(DirectedGraph<V, E> graph, V node) {
        BreadthFirstIterator<V, E> iterator = new BreadthFirstIterator<V, E>(graph, node);
    ...
    public static <V, E> V parent(DirectedGraph<V, E> tree, V node) {
        ...
        BreadthFirstIterator<V, E> iterator = new BreadthFirstIterator<V, E>(reversedTree, node);
